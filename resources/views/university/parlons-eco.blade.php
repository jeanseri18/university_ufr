        ...
        <div class="row align-items-center">
            <div class="col-lg-8 mb-6 mb-lg-0">
                <div>
                    ...
                    <h1 class="display-3 fw-bold mb-3 text-white">PARLONS ECONOMIE</h1>
...
<section class="my-5 py-5 ">
    <div class="container">
        {{-- <div class="banner mb-4">
            <h1 class="display-4 banner-title">Parlons Eco</h1>
        ...
        <div class=" my-5">
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        <img src="{{ asset('/assets/etudiant-afro.jpg') }}" class="card-img-top" alt="Image d'un étudiant">
                        <div class="card-body">
                            <h5 class="card-title">Mon premier titre</h5>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <img src="{{ asset('/assets/etudiant-afro.jpg') }}" class="card-img-top" alt="Image d'un étudiant">
                        <div class="card-body">
                            <h5 class="card-title">Mon deuxième titre</h5>
                            {{-- <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p> --}}
                            <a href="#" class="btn btn-link">Lire plus</a>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <img src="{{ asset('/assets/etudiant-afro.jpg') }}" class="card-img-top" alt="Image d'un étudiant">
                        <div class="card-body">
                            <h5 class="card-title">Mon troisième titre</h5>
                            {{-- <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p> --}}
                            <a href="#" class="btn btn-link">Lire plus</a>
                        </div>
                    </div>
